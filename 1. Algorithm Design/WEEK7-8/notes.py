"""
Trace tables are a way for us to think like the computer does.

We need to understand what the output should be for every 
individual test case which can pile up when we use WHILE
or FOR loops.
